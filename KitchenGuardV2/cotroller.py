...
class Controller:
    ...
    def handle_powerplug_state(self, data: dict) -> None:
    ...
    def handle_motion_sensor(self, data: dict) -> None:
    ...
    def handle_stove_turn_off(self, client) -> None:
    ...
    def handle_lights(self, client) -> None:
